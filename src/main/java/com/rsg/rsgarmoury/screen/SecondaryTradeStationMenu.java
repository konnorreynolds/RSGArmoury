...
public class SecondaryTradeStationMenu extends AbstractContainerMenu {
    ...
    public final SecondaryTradeStationEntity blockEntity;
    private final Level level;
    private final ContainerData containerData;

    public SecondaryTradeStationMenu(int pContainerId, Inventory pInventory, FriendlyByteBuf pExtraData) {
        this(pContainerId, pInventory, pInventory.player.level().getBlockEntity(pExtraData.readBlockPos()), new SimpleContainerData(2));
    }

    public SecondaryTradeStationMenu(int pContainerId, Inventory pInventory, BlockEntity pBlockEntity, ContainerData pContainerData) {
        super(RSGMenuTypes.SECONDARY_TRADE_MENU.get(), pContainerId);
        checkContainerSize(pInventory, 2);
        blockEntity = ((SecondaryTradeStationEntity) pBlockEntity);
    ...
    public int getScaledProgress() {
        ...
        int progressArrowSize = 26; // Height of pixels
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, RSGBlocks.SECONDARY_TRADE_STATION.get());
    }
